...
const AddressPill: React.FC<IProps> = ({
  ...
  return (
    <div className="inline-flex items-center text-black bg-gray-100 rounded-full border border-solid border-gray-300 dark:text-gray-100 dark:bg-blackPearl dark:border-darkblue">
      {!isBalanceHidden && (
      ...
      <Link passHref={false} href={href}>
        <a
          className="px-2 md:px-2 py-1 flex items-center text-xs md:text-sm font-medium bg-white text-black rounded-full border-l border-solid border-gray-300 
