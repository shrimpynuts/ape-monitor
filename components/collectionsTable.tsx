...
//     <input
//       ref={inputRef}
//       className="hidden md:block px-8 py-2 rounded-sm w-64 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-darkblue"
//       value={filterValue || ''}
//       onChange={(e) => {
            ...
            {value ? (
              <>
                ...
                {value[`${currentTimespan.dataPrefix}_volume`] > 0 && (
                  <span className="text-green-600">+{fixedNumber(value[`${currentTimespan.dataPrefix}_volume`])}Ξ</span>
                )}
              </>
            ) : (
              ''
